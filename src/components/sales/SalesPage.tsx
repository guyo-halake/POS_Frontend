...
export const SalesPage: React.FC = () => {
  ...
  return (
    <div className="p-4 md:p-8 pb-24 md:pb-8 max-w-7xl mx-auto h-[calc(100vh-6rem)] flex flex-col">
      <div className="mb-8">
        <h1 className="text-3xl font-black tracking-tight uppercase flex items-center gap-3">
          <History className="w-8 h-8" />
          Receipts & Sales
        </h1>
        <p className="text-muted-foreground mt-2">View and manage all your store transactions.</p>
      </div>

      <div className="flex-1 bg-card border border-foreground/10 flex flex-col min-h-0 shadow-sm">
        {selectedSale ? (
          <div className="flex flex-col flex-1 min-h-0 p-6">
            ...
            <div className="bg-muted/30 p-8 flex-1 overflow-y-auto flex justify-center">
              <div className="bg-card w-full max-w-sm shadow-xl border border-foreground/10 p-6 flex flex-col relative text-foreground h-fit">
